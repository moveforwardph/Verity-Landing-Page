  ...
  const phase2Features = [
    {
      ...
      description:
        "Seamless integration with PNP and Emergency Operations Centers",
      status: "Coming 2025",
    },
    {
      icon: Database,
      ...
      description:
        "Real-time data sharing across security networks and jurisdictions",
      status: "Development",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Centralized, immutable evidence storage with chain-of-custody",
      status: "Coming 2025",
    },
    {
      icon: MapPin,
    ...
    },
    {
      ...
      description:
        "International security information sharing and coordination",
      status: "Vision 2026",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Building towards a connected ecosystem where security operations are
            seamlessly integrated, intelligently automated, and globally
            coordinated.
          </p>
        </div>
